<h1 align="center"> 🚀 Sort Number | Vanilla </h1>

## ✍️ Descrição
Exemplificação de aplicação de  sorteador usando vanilla ou Javascript puro
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/sort-number-vanilla.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/QWBrgYQ) 
